...
public class database {
	...
	public static int proInsert(ProblemAbstract problem) {
	...
	public static int proUpdate(ProblemAbstract problem) {
	    Connection conn = getConn();
	    int i = 0;
	...
	public static ProblemAbstract proSearch(int pro_id){
		 Connection conn = getConn();
	...
	public static ArrayList<ProblemAbstract> searchMyProblem(int user_id){
		 Connection conn = getConn();
	...
	public static int proDelete(String proname) {
	    Connection conn = getConn();
	    int i = 0;
	...
	public static int solInsert(JudgeResult solution) {
	    Connection conn = getConn();
	...
	public static ArrayList<JudgeResult> searchMySolution(int user_id){
		 Connection conn = getConn();
	...
	public static ArrayList<JudgeResult> searchAllSolution(int pro_id){
		 Connection conn = getConn();
